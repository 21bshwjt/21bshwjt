...
- 🔐 Specialized in **Identity & Access Management (IAM)**, **Active Directory**, **Microsoft Entra ID**, **PAM**, **IGA**, and **PKI**
- ☁️ Working across **Microsoft 365 Security**, **Azure / Entra ID**, and hybrid identity environments
- 🛡️ Passionate about **Zero Trust**, **Tiered Administration**, **JIT/JEA**, and enterprise hardening
- 💻 Building automation with **PowerShell**, **Microsoft Graph API**, and **Azure Automation**
- 🔎 Focused on **Identity Security**, **Conditional Access**, **Security Assessments**, and **Tenant Hardening**
- 🚀 Exploring **DevSecOps**, **Cloud Security**, and identity-driven automation
- 🤝 Open to collaborating on **IAM**, **Security Automation**, and **Microsoft Security** projects
